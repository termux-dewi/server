...
// Variables
const rootDomain = "kme.ip-ddns.com"; // Ganti dengan domain utama kalian
const serviceName = "mamamuram"; // Ganti dengan nama workers kalian
const apiKey = "f0fb8b07ad8d6fe62184883cfaf1add17b920"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "kamamutiara@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "669a07079a2f481f72c99b2444f6a04a"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "d7b5c2d39e73eec9156800b7170a6b42"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
